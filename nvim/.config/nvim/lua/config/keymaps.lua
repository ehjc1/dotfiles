...
-- Point the explorer at cwd instead of the root dir, so a multi-repo workspace
-- doesn't reparent the tree onto whichever repo the current file belongs to.
-- Everything else (lazygit, grep, find) keeps LSP/git root detection.
keymap("n", "<leader>e", "<leader>fE", { remap = true, desc = "Explorer NeoTree (cwd)" })
